...
int main()
{
    ...
    pic[11]= {1030,160,70,30,  txLoadImage ("Pics\\Spoler2.bmp"),true,25,8,"Spoler"};
    pic[12] ={1030,240,70,30,  txLoadImage ("Pics\\Spoler3.bmp"),true,60,8,"Spoler"};
    pic[13] ={1030,320,70,30,  txLoadImage ("Pics\\Spoler4.bmp"),true,65,8,"Spoler"};
    ...
    mapParts[13]=  {680,253,174,174,txLoadImage ("Pics\\Spoler4.bmp"),false,65,8,"Spoler"};
